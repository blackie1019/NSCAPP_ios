...
*/
//global data
var Setting_imgSrc="http://TAP0923.nsc.gov.tw/AppService/GetFile.do?fs=1&ftype=lbs&isAttache=false&path=server1/lbsData/";
var Setting_classifyImgSrc="http://TAP0923.nsc.gov.tw/AppService/GetFile.do?fs=1&ftype=lbs&isAttache=false&path=server1/classify/";
var Setting_lineImgSrc="http://TAP0923.nsc.gov.tw/AppService/GetFile.do?fs=1&ftype=lbs&isAttache=false&path=server1/line/";
var Setting_FAQImgSrc="http://TAP0923.nsc.gov.tw/AppService/GetFile.do?fs=1&ftype=lbs&isAttache=false&path=server1/faqClassify/";
...
/*DB*/
var commonURL_DB="http://TAP0923.nsc.gov.tw/AppService/Main.do?name=commonURL_DB&jsoncallback=?";
/*LBS*/
var queryURL_LBS_LandInfo="http://TAP0923.nsc.gov.tw/AppService/Main.do?name=queryURL_LBS_LandInfo&jsoncallback=?";
var queryURL_LBS_EntryPoint="http://TAP0923.nsc.gov.tw/AppService/Main.do?name=queryURL_LBS_EntryPoint&jsoncallback=?";
var deleteURL_LBS_LandInfo="http://TAP0923.nsc.gov.tw/AppService/Main.do?name=deleteURL_LBS_LandInfo";
var deleteURL_LBS_EntryPoint="http://TAP0923.nsc.gov.tw/AppService/Main.do?name=deleteURL_LBS_EntryPoint";
var updateURL_LBS_LandInfo="http://TAP0923.nsc.gov.tw/AppService/Main.do?name=updateURL_LBS_LandInfo";
var updateURL_LBS_EntryPoint="http://TAP0923.nsc.gov.tw/AppService/Main.do?name=updateURL_LBS_EntryPoint";
var insertURL_LBS_LandInfo="http://TAP0923.nsc.gov.tw/AppService/Main.do?name=insertURL_LBS_LandInfo";
var insertURL_LBS_EntryPoint="http://TAP0923.nsc.gov.tw/AppService/Main.do?name=insertURL_LBS_EntryPoint";
//Data
/*科學園區簡介*/
var DataURL_ParkIntro="http://TAP0923.nsc.gov.tw/AppService/Main.do?name=DataURL_ParkIntro&jsoncallback=?";
/*訊息與活動*/
var DataURL_NewsAndEvents_LP="http://TAP0923.nsc.gov.tw/AppService/getNews.do?name=DataURL_NewsAndEvents_LP&jsoncallback=?";
var DataURL_NewsAndEvents_CP="http://TAP0923.nsc.gov.tw/AppService/getNewsCP.do?name=DataURL_NewsAndEvents_CP&jsoncallback=?";
/*廠商資訊*/
var DataURL_VendorInfo_QP="http://TAP0923.nsc.gov.tw/AppService/getVendorInfo.do?name=DataURL_VendorInfo_QP&jsoncallback=?";
var DataURL_VendorInfo_LP="http://TAP0923.nsc.gov.tw/AppService/getVendorInfoLP.do?name=DataURL_VendorInfo_LP&jsoncallback=?";
var DataURL_VendorInfo_CP="http://TAP0923.nsc.gov.tw/AppService/getVendorInfoCP.do?name=DataURL_VendorInfo_CP&jsoncallback=?";
var DataURL_VendorInfo_sub_CP="http://TAP0923.nsc.gov.tw/AppService/getVendorInfoSubCP.do?name=DataURL_VendorInfo_sub_CP&jsoncallback=?";
/*交通資訊*/
var DataURL_TranspoltInfo_index="http://TAP0923.nsc.gov.tw/AppService/json/Page_TranspotInfo_index.json";
var DataURL_TranspoltInfo_aroundStop="http://TAP0923.nsc.gov.tw/TransportService/NeighborService?name=DataURL_TranspoltInfo_aroundStop&jsoncallback=?";
var DataURL_TranspoltInfo_index_03="http://TAP0923.nsc.gov.tw/TransportService/HighwayBusQueryService?name=DataURL_TranspoltInfo_index_03&jsoncallback=?";
var DataURL_TranspoltInfo_index_04="http://TAP0923.nsc.gov.tw/TransportService/PublicBusQueryService?name=DataURL_TranspoltInfo_index_04&jsoncallback=?";
var DataURL_TranspoltInfo_index_05="http://TAP0923.nsc.gov.tw/TransportService/TrafficLineService?name=DataURL_TranspoltInfo_index_05&jsoncallback=?";
var DataURL_TranspoltInfo_LP_01="http://TAP0923.nsc.gov.tw/TransportService/ThsrcTimetableService?name=DataURL_TranspoltInfo_LP_01&jsoncallback=?";
var DataURL_TranspoltInfo_LP_02="http://TAP0923.nsc.gov.tw/TransportService/RailwayTimetableService?name=DataURL_TranspoltInfo_LP_02&jsoncallback=?";
var DataURL_TranspoltInfo_LP_03="http://TAP0923.nsc.gov.tw/TransportService/HighwayBusTimetableService?name=DataURL_TranspoltInfo_LP_03&jsoncallback=?";
var DataURL_TranspoltInfo_LP_04_1="http://TAP0923.nsc.gov.tw/TransportService/PublicBusTimetableService?name=DataURL_TranspoltInfo_LP_04_1&jsoncallback=?";
var DataURL_TranspoltInfo_LP_05_1="http://TAP0923.nsc.gov.tw/TransportService/TrafficAllinOne?name=DataURL_TranspoltInfo_LP_05_1&jsoncallback=?";
var DataURL_TranspoltInfo_BusStopMap="http://TAP0923.nsc.gov.tw/TransportService/TurningPointService?name=DataURL_TranspoltInfo_BusStopMap&jsoncallback=?";
var DataURL_TranspoltInfo_BusMap="http://TAP0923.nsc.gov.tw/TransportService/BusLocationService?name=DataURL_TranspoltInfo_BusMap&jsoncallback=?";
var DataURL_TranspoltInfo_LP_05_2="http://TAP0923.nsc.gov.tw/TransportService/TrafficQueryLineService?name=DataURL_TranspoltInfo_LP_05_2&jsoncallback=?";
var DataURL_TranspoltInfo_QP_05="http://TAP0923.nsc.gov.tw/TransportService/TrafficQueryService?name=DataURL_TranspoltInfo_QP_05&jsoncallback=?";
var DataURL_TranspoltInfo_CP_01="http://TAP0923.nsc.gov.tw/TransportService/ThsrcTransferService?name=DataURL_TranspoltInfo_CP_01&jsoncallback=?";
var DataURL_TranspoltInfo_CP_02="http://TAP0923.nsc.gov.tw/TransportService/RailwayTransferService?name=DataURL_TranspoltInfo_CP_02&jsoncallback=?";
var DataURL_TranspoltInfo_CP_05="http://TAP0923.nsc.gov.tw/TransportService/TrafficTransferService?name=DataURL_TranspoltInfo_CP_05&jsoncallback=?";
var DataURL_TranspoltInfo_CP_09="http://TAP0923.nsc.gov.tw/AppService/Main.do?name=commonURL_DB&jsoncallback=?";
var DataURL_TranspoltInfo_getRouteLocationInfo="http://TAP0923.nsc.gov.tw/AppService/getRouteLocationInfo.do?name=getRouteLocationInfo&jsoncallback=?";
/*生活服務*/
var DataURL_Classify="http://TAP0923.nsc.gov.tw/AppService/getLifeService.do?name=DataURL_Classify&jsoncallback=?"
/*廠商徵才資訊*/
var DataURL_Jobs_QP="http://TAP0923.nsc.gov.tw/AppService/getVendorJobInfo.do?name=DataURL_Jobs_QP&jsoncallback=?";
var DataURL_Jobs_LP="http://TAP0923.nsc.gov.tw/AppService/getVendorJobInfoLP.do?name=DataURL_Jobs_LP&jsoncallback=?";
var DataURL_Jobs_CP="http://TAP0923.nsc.gov.tw/AppService/getVendorJobInfoCP.do?name=DataURL_Jobs_CP&jsoncallback=?";
/*關於*/
/*系統公告*/
var DataURL_SystemMessage="http://TAP0923.nsc.gov.tw/AppService/json/SystemMessage.json";
/*其他APP*/
var DataURL_AppInfo="http://TAP0923.nsc.gov.tw/AppService/json/AppInfo.json";
/*常見問題*/
var DataURL_FAQ_NP="http://TAP0923.nsc.gov.tw/AppService/getFAQInfo.do?name=DataURL_FAQ_NP&jsoncallback=?";
var DataURL_FAQ_LP="http://TAP0923.nsc.gov.tw/AppService/getFAQLP.do?name=DataURL_FAQ_LP&jsoncallback=?";
var DataURL_ContactUs="http://TAP0923.nsc.gov.tw/AppService/getAboutUs.do?name=DataURL_ContactUs&jsoncallback=?"
/*即時業務資訊*/
/*即時公告*/
var InstantMessage="http://TAP0923.nsc.gov.tw/AppService/getAppInstantMessageLP.do?name=InstantMessage&jsoncallback=?";
/*內部訊息公告*/
var InsideInstantMessage_LP="http://TAP0923.nsc.gov.tw/AppService/getInsideInstantMessageLP.do?name=InsideInstantMessage_LP&jsoncallback=?";
var InsideInstantMessage_CP="http://TAP0923.nsc.gov.tw/AppService/getInsideInstantMessageCP.do?name=InsideInstantMessage_CP&jsoncallback=?";
/*公文簽核待辦通知*/
var DataURL_OfficialDocument_LP="http://TAP0923.nsc.gov.tw/AppService/json/Page_OfficialDocument_LP.json";
var DataURL_OfficialDocument_index_lees="http://TAP0923.nsc.gov.tw/AppService/json/Page_OfficialDocument_index_lees.json";
var DataURL_OfficialDocument_index_ken="http://TAP0923.nsc.gov.tw/AppService/json/Page_OfficialDocument_index_ken.json";
/*新聞剪影*/
var DataURL_NewsAndDocument_index="http://TAP0923.nsc.gov.tw/AppService/Main.do?name=DataURL_NewsAndDocument_index&jsoncallback=?";
var DataURL_NewsAndDocument_LP="http://TAP0923.nsc.gov.tw/AppService/Main.do?name=DataURL_NewsAndDocument_LP&jsoncallback=?";
var DataURL_NewsAndDocument_CP="http://TAP0923.nsc.gov.tw/AppService/Main.do?name=DataURL_NewsAndDocument_CP&jsoncallback=?";
...
var DataURL_LBSQueryService="http://TAP0923.nsc.gov.tw/TransportService/LBSQueryService?name=DataURL_LBSQueryService&jsoncallback=?";
/*園區判定*/
var DataURL_ParkBaseArea="http://TAP0923.nsc.gov.tw/AppService/json/area.json"; 
// var DataURL_ParkBaseArea="json/area.json"; 
/*會員資料*/
var DataURL_MemberData_getToken1="http://TAP0923.nsc.gov.tw/AppService/GetToken1.do?name=DataURL_MemberData_getToken1&jsoncallback=?";
var DataURL_MemberData_vaildToken1="http://TAP0923.nsc.gov.tw/AppService/ValidToken1.do?name=DataURL_MemberData_vaildToken1&jsoncallback=?";
var DataURL_MemberData_getToken2="http://TAP0923.nsc.gov.tw/AppService/GetToken2.do?name=DataURL_MemberData_getToken2&jsoncallback=?";
var DataURL_MemberData_vaildToken2="http://TAP0923.nsc.gov.tw/AppService/ValidToken2.do?name=DataURL_MemberData_vaildToken2&jsoncallback=?";
//Richard Dev
/*Page_ChooseUser.html*/
var DataURL_OfficialDocument_AGENT = "http://TAP0923.nsc.gov.tw/AppService/GetODAgentInfo.do";
var DataURL_BFS_GETORGLIST = "http://TAP0923.nsc.gov.tw/AppService/getOrgList.do?jsoncallback=?";
var DataURL_BFS_GETORGINFO = "http://TAP0923.nsc.gov.tw/AppService/getOrgInfo.do?jsoncallback=?";
/*Page_BizFileSharing.html*/
var DataURL_BFS = "http://TAP0923.nsc.gov.tw/AppService/Main.do";
var DataURL_BFS_android_Upload = "http://TAP0923.nsc.gov.tw/AppService/Upload.do";
/*Page_officialDocument.html*/
var DataURL_OfficialDocument_LP = "http://TAP0923.nsc.gov.tw/AppService/GetODToListMobInfo.do";
